...
<%
	...
	MultipartRequest multi = new MultipartRequest(request, savePath, 5 * 1024 * 1024, "utf-8",	new DefaultFileRenamePolicy());/* 파일 업로드 시점 */
	...
	Enumeration files = multi.getFileNames();
	 ...
	 while (files.hasMoreElements()) {
		...
		File file = multi.getFile(name);//파일 객체 가져오는 
